...
export WORLD_SIZE=2
export RANK=1
# python /usr/local/lib/python3.6/dist-packages/torch/distributed/launch.py --nnode=2 --node_rank=1 --nproc_per_node=1 dlrm_s_pytorch.py --mini-batch-size=2 --data-size=6
